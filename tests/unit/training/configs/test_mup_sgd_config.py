...
def test_build_mup_sgd_config():
    cfg = build_optimizer_config("sgd", lr=0.01, mup=True, weight_decay=0.1)
...
def test_json_roundtrip():
    original = SgdConfig(lr=0.5, mup=True)
...
def test_build_from_dict():
    data = {"optimizer_type": "sgd", "lr": 1.23, "mup": True, "weight_decay": 0.2}
