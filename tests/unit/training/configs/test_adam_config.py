...
def test_build_adam_config():
    cfg = build_optimizer_config("Adam", lr=0.01, weight_decay=0.1)
...
def test_build_from_dict():
    data = {"optimizer_type": "Adam", "lr": 1.23, "weight_decay": 0.2}
