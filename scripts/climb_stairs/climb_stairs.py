#!/usr/bin/env python3
"""Run a Staircase experiment from a YAML configuration."""
...
import src.experiments.experiments.staircase_experiment  # noqa: F401
...
CONFIG_FILE = SCRIPT_DIR / "climb_stairs.yaml"
