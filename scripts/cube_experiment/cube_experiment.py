#!/usr/bin/env python3
"""Run a Cube experiment from a YAML configuration."""
...
import src.experiments.experiments.cube_experiment  # noqa: F401
...
CONFIG_FILE = SCRIPT_DIR / "cube_experiment.yaml"
